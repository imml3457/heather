...
PACKABLE_STYLE(heather) {
    ...
    s.search.fg     = MAYBE_CONVERT(0x99ffe6);
    ...
    s.search_cursor.fg     = MAYBE_CONVERT(0x36d339);
    ...
    s.associate.bg     = MAYBE_CONVERT(0xff92c2);
    ...
    s.status_line.bg     = MAYBE_CONVERT(0xff92c2);
